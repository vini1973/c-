	...
	<tbody>
		<tr class="linhaClara">
			...
			<td>
                ...
                &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator" runat="server" ControlToValidate="nomeid"
					ErrorMessage="Este campo é requerido" EnableClientScript="True"></asp:RequiredFieldValidator>
                </td>
		</tr>
